...
main  (  )
{
	...
	<bb 5> :
	$T28 = std::basic_ostream<char, std::char_traits<char>>& std::operator<<<std::char_traits<char>>  ( &std::cout, R"("Division Result is: ")" );
	$T4 = $T28;
	...
	ex = *$T17;
	$T20 = std::basic_ostream<char, std::char_traits<char>>& std::operator<<<std::char_traits<char>>  ( &std::cout, R"("Exception: Divide by zero not allowed :")" );
