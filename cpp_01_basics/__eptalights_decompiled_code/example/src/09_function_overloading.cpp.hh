...
Geeks::func  ( this, x )
{
	...
	<bb 2> :
	$T5 = std::basic_ostream<char, std::char_traits<char>>& std::operator<<<std::char_traits<char>>  ( &std::cout, R"("value of x is ")" );
	$T1 = $T5;
...
Geeks::func  ( this, x, y )
{
	...
	<bb 2> :
	$T7 = std::basic_ostream<char, std::char_traits<char>>& std::operator<<<std::char_traits<char>>  ( &std::cout, R"("value of x and y is ")" );
	$T1 = $T7;
	$T10 = std::ostream::operator<<  ( $T1, x );
	$T2 = $T10;
	$T12 = std::basic_ostream<char, std::char_traits<char>>& std::operator<<<std::char_traits<char>>  ( $T2, R"(", ")" );
	$T3 = $T12;
